...
class wetplaceGenreScreen(Screen):
	...
	def __init__(self, session):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/wetplaceGenreScreen.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/wetplaceGenreScreen.xml"
		print path
...
class wetplaceFilmScreen(Screen):
	...
	def __init__(self, session, phCatLink):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/wetplaceFilmScreen.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/wetplaceFilmScreen.xml"
		print path
		with open(path, "r") as f:
			self.skin = f.read()
			f.close()
