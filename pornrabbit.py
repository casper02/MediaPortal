...
class pornrabbitGenreScreen(Screen):
	...
	def __init__(self, session):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/pornrabbitGenreScreen.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/pornrabbitGenreScreen.xml"
		print path
...
class pornrabbitFilmScreen(Screen):
	...
	def __init__(self, session, phCatLink):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/pornrabbitFilmScreen.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/pornrabbitFilmScreen.xml"
		print path
		with open(path, "r") as f:
			self.skin = f.read()
			f.close()
