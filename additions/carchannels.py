...
class show_CAR_Genre(Screen):
	...
	def layoutFinished(self):
		...
		self.genreliste.append((3,'BMW Motorrad', '/bmwmotorrad'))
		self.genreliste.append((4,'Ducati Motor Official Channel', '/DucatiMotorHolding'))
		self.genreliste.append((5,'Fiat Deutschland', '/FiatDeutschland'))
		self.genreliste.append((6,'Harley-Davidson Europe', '/HarleyDavidsonEurope'))
		self.genreliste.append((7,'Honda Deutschland', '/HondaDeutschlandGmbH'))
		self.genreliste.append((8,'Kawasaki Motors Europe', '/Kawasakimotors'))
		self.genreliste.append((9,'Land Rover Deutschland', '/experiencegermany'))
		self.genreliste.append((10,'Mazda Deutschland', '/MazdaDeutschland'))
		self.genreliste.append((11,'MITSUBISHI MOTORS Deutschland', '/MitsubishiMotorsDE'))
		self.genreliste.append((12,'Moto Guzzi', '/motoguzziofficial'))
		self.genreliste.append((13,'SEAT Deutschland', '/SEATde'))
		self.genreliste.append((14,'ŠKODA AUTO Deutschland', '/skodade'))
		self.genreliste.append((15,'Toyota Deutschland', '/toyota'))
		self.genreliste.append((16,'Official Triumph Motorcycles', '/OfficialTriumph'))
		self.genreliste.append((17,'Volkswagen', '/myvolkswagen'))
		self.genreliste.append((18,'Yamaha Motor Europe', '/YamahaMotorEurope'))
