...
class show_CAR_Genre(Screen):
	...
	def layoutFinished(self):
		...
		self.genreliste.append((4,'Harley-Davidson Europe', '/HarleyDavidsonEurope'))
		self.genreliste.append((5,'Honda Deutschland', '/HondaDeutschlandGmbH'))
		self.genreliste.append((6,'Kawasaki Motors Europe', '/Kawasakimotors'))
		self.genreliste.append((7,'Land Rover Deutschland', '/experiencegermany'))
		self.genreliste.append((8,'Mazda Deutschland', '/MazdaDeutschland'))
		self.genreliste.append((9,'MITSUBISHI MOTORS Deutschland', '/MitsubishiMotorsDE'))
		self.genreliste.append((10,'Moto Guzzi', '/motoguzziofficial'))
		self.genreliste.append((11,'SEAT Deutschland', '/SEATde'))
		self.genreliste.append((12,'ŠKODA AUTO Deutschland', '/skodade'))
		self.genreliste.append((13,'Toyota Deutschland', '/toyota'))
		self.genreliste.append((14,'Official Triumph Motorcycles', '/OfficialTriumph'))
		self.genreliste.append((15,'Volkswagen', '/myvolkswagen'))
		self.genreliste.append((16,'Yamaha Motor Europe', '/YamahaMotorEurope'))
