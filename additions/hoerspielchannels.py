...
class show_HSC_Genre(Screen):
	...
	def layoutFinished(self):
		...
		self.genreliste.append((4,'Edgar Allan Poe´s Kaminzimmer', '/EAPoeProductions'))
		self.genreliste.append((5,'felix auris', '/mercuriius'))
		self.genreliste.append((6,'FRUITY - SOUND - DISASTER', '/MrFruitylooper'))
		self.genreliste.append((7,'Hörbücher, Hörspiele und mehr', '/BestSound1000'))
		self.genreliste.append((8,'Hörspielprojekt', '/Hoerspielprojekt'))
		self.genreliste.append((9,'LAUSCH - Phantastische Hörspiele', '/merlausch'))
		self.genreliste.append((10,'Nostalgiekanal - Hörspielkiste', '/Hoerspielkiste'))
		self.genreliste.append((11,'Soundtales Productions', '/SoundtalesProduction'))
