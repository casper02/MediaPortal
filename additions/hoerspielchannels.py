...
class show_HSC_Genre(Screen):
	...
	def layoutFinished(self):
		...
		self.genreliste.append((4,'FRUITY - SOUND - DISASTER', '/MrFruitylooper'))
		self.genreliste.append((5,'Hörbücher, Hörspiele und mehr', '/BestSound1000'))
		self.genreliste.append((6,'Hörspielprojekt', '/Hoerspielprojekt'))
		self.genreliste.append((7,'LAUSCH - Phantastische Hörspiele', '/merlausch'))
		self.genreliste.append((8,'Soundtales Productions', '/SoundtalesProduction'))
