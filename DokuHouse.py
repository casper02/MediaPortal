...
class show_DH_Genre(Screen):
	...
	def __init__(self, session):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/show_DH_Genre.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/show_DH_Genre.xml"
		print path
...
class DH_FilmListeScreen(Screen):
	...
	def __init__(self, session, genreLink, genreName):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/DH_FilmListeScreen.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/DH_FilmListeScreen.xml"
		print path
		with open(path, "r") as f:
			self.skin = f.read()
			f.close()
...
class DH_Streams(Screen, ConfigListScreen):
	...
	def __init__(self, session, dokuUrl, dokuName):
		...
		path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/%s/DH_Streams.xml" % config.mediaportal.skin.value
		if not fileExists(path):
			path = "/usr/lib/enigma2/python/Plugins/Extensions/mediaportal/skins/original/DH_Streams.xml"
		print path
		with open(path, "r") as f:
			self.skin = f.read()
			f.close()
